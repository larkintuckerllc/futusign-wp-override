...
function futusign_override_missing_futusign() {
	...
	$target = false;
	$action = __('Install', 'futusign_override');
	if ( current_user_can( 'install_plugins' ) ) {
		if ( $is_installed ) {
			$action = __('Activate', 'futusign_override');
	...
	<div class="notice error is-dismissible">
		<p><strong>futusign Override</strong> <?php esc_html_e('depends on the last version of futusign to work!', 'futusign_override' ); ?></p>
...
futusign_override_missing_futusign();
